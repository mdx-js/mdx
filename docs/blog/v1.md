...
For example, it allows tools like prettier to use the exact same parser as us by using the new plugin to
format MDX documents.  Or you use `remark-mdx` in combination with [remark-lint](#) to check your MDX.
