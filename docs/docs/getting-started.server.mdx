...
Optionally, if you haven’t already, you can also add Astro integrations for
frameworks such as React, Preact, Vue, Svelte, and more.
Each integration lets you use components written in that framework from within
MDX files.
See Astro’s
[Framework components](https://docs.astro.build/en/core-concepts/framework-components/)
