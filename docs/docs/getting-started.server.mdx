...
We recommend using [the `astro add` CLI](https://docs.astro.build/en/guides/integrations-guide/#automatic-integration-setup)
...
[Astro](https://docs.astro.build/en/core-concepts/astro-components/),
