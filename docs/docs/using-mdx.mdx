...
This will be used by [the MDX VS Code extension](https://marketplace.visualstudio.com/items?itemName=unifiedjs.vscode-mdx) to show JSDoc information and errors in IntelliSense hovers (see the [MDX Analyzer Props docs](https://github.com/mdx-js/mdx-analyzer#props) for more details):
