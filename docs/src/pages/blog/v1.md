...
ZEIT Day.  MDX was a radical paradigm shift in how to write immersive content using components.  It’s
an open, authorable format that makes it fun to write again.

It was also a rather buggy, alpha library that had a lot of improvements that needed to be made.
After a year of working on bug fixes, new features, and integration tests we’re happy to finally
release v1!
