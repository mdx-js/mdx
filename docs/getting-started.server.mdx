...
*   If you’re using **esbuild**,
    please install and configure [`@mdx-js/esbuild`][mdx-esbuild]
*   If you’re using **Rollup**
    (or Vite or WMR, which use it),
    please install and configure [`@mdx-js/rollup`][mdx-rollup]
*   If you’re using **webpack**
    (or Create React App (CRA), Next.js, Razzle, React Static, or Vue CLI,
    which use it),
    please install and configure [`@mdx-js/loader`][mdx-loader]
...
{/* to do: call out the below? */}

{<small>we’re looking for help with atom, emacs, and others!</small>}
